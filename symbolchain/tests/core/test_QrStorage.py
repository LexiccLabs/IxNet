...
class QrStorageTest(unittest.TestCase):
    ...
    def test_can_save_empy_buffer(self):
    ...
    def test_can_save_max_buffer(self):
        self._assert_can_save_buffer(1155)
    ...
    def test_cannot_save_more_than_allowable_number_of_signatures(self):
        ...
        with tempfile.TemporaryDirectory() as temp_directory:
            ...
            buffer = NemTestUtils.randbytes(1156)
    ...
    def _assert_can_roundtrip_buffer(self, data_size):
        ...
        with tempfile.TemporaryDirectory() as temp_directory:
            ...
            # Assert:
            self.assertEqual(loaded_buffer, buffer)

    def test_can_roundtrip_empy_buffer(self):
